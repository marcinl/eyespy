...
if __name__ == '__main__':
    ...
    while(RUNNING):
        ...
        face_locations, face_IDs = face_tracker.get_face_locations(frame, num_frames)
        #img, faces_locations, face_ids = face_tracker.get_face_locations(frame, num_frames) # TODO return face dict
        # faces_locations = get_face_locations_old(frame)

        recognized_faces = recognizer.recognize_faces(frame, num_frames, face_locations, face_IDs)
        #recognized_faces = recognizer.get_identifiers(face_locations, face_IDs, num_frames, frame)
